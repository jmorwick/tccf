...
(isset($context["view_mode"]) ? $context["view_mode"] : null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass((isset($context["view_mode"]) ? $context["view_mode"] : null)))) : ("")));
  ...
  ";
      ...
      <div";
            // line 89
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["author_attributes"]) ? $context["author_attributes"] : null), "addClass", array(0 => "submitted"), "method"), "html", null, true));
            echo ">
        ";
            // line 90
...
";
    ...
    {
        return new Twig_Source("", "themes/danland/templates/node.html.twig", "/var/www/tccf/html/drupal/themes/danland/templates/node.html.twig");
    }
}
